...
model_folder = '/Users/benjaminarias/Documents/GitHub/climate_change_project/notebooks/david_craig/prophet_models'
city_models = {}
...
future = model.make_future_dataframe(periods=(years_into_future+1)*12, freq='MS')  # +1 pour s'assurer d'avoir assez de données
...
print('FORECAST YEARS:', forecast['year'].unique())
print('FORECAST MONTHS:', forecast['month'].unique())
...
# 7. Find prediction for the specific month and year
target_row = forecast[
    (forecast['year'] == target_year) & 
    (forecast['month'] == target_month)
].iloc[0]
